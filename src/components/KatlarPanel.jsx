                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 flex-wrap">
                      ...
                      {kat.rampa_sayisi > 0 && (
                        <span className="text-xs text-gray-400">Rampa: <span className="text-gray-600">{kat.rampa_sayisi}</span></span>
                      )}
                      {kat.asmakat_var && (
      ...
      {formAcik && (
        <div className="bg-white rounded-lg border border-blue-200 p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">Rampa Sayısı</label>
              <input type="number" value={form.rampa_sayisi || ''} onChange={e => set('rampa_sayisi', e.target.value)}
                className="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-400"
                placeholder="0" />
            </div>
          </div>
