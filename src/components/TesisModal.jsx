...
const bos = {
  ...
  ruhsat: { seviye: null, gecerlilik_tarihi: '', uyari_gun: '', belge_link: '', belge_base64: '', belge_adi: '' },
  ced: { seviye: null, onay_tarihi: '', belge_link: '', belge_base64: '', belge_adi: '' },
  itfaiye: { seviye: null, gecerlilik_tarihi: '', uyari_gun: '', belge_link: '', belge_base64: '', belge_adi: '' },
  raci: {
    ruhsat: { R: [], A: [], C: [], I: [] },
    itfaiye: { R: [], A: [], C: [], I: [] },
    ced: { R: [], A: [], C: [], I: [] },
        ...
        <div key={rol} className="flex items-start gap-2 mb-1.5">
          ...
          <div className="flex flex-wrap gap-1">
            {RACI_SECENEKLER.map(s => (
              <button key={s} onClick={() => toggle(rol, s)}
...
export default function TesisModal({ tesis, onKaydet, onKapat }) {
  const [form, setForm] = useState(tesis ? {
    ...
    ruhsat: tesis.ruhsat || { seviye: null, gecerlilik_tarihi: '', uyari_gun: '', belge_link: '', belge_base64: '', belge_adi: '' },
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => { if (yeniSecondaryRol.trim()) { toggleSecondary('operator_rolu_secondary', yeniSecondaryRol.trim()); setYeniSecondaryRol('') } }}
                    className="text-xs px-3 py-1.5 bg-gray-100 rounded-lg text-gray-600 hover:bg-gray-200">Ekle
                  </button>
                </div>
